...
module.exports = {
  ...
  logo: '/img/JX-Logo.png', // 导航栏logo
  repo: 'ALLforJianXin/allforjianxin.github.io', // 导航栏右侧生成Github链接
  ...
  // bodyBgImg: '/img/bg.jpeg', // body背景大图，默认无。 单张图片 String || 多张图片 Array, 多张图片时每隔15秒换一张。
  ...
  author: {
    ...
    name: 'jxpress', // 必需
    link: 'https://github.com/ALLforJianXin', // 可选的
  },
  // blogger: {
  //   // 博主信息，显示在首页侧边栏
    ...
    icons: [
      {
        ...
        title: '发邮件',
        link: 'mailto:allforjianxin@gmail.com',
      },
      // {
  ...
  privatePage: {
    ...
    loginPath: "/jxpress/login/",    // 引用登录组件的 md 文章中 frontmatter 的 permalink。（必须），建议支持 /vdoing/login/，无默认值
    loginKey: 'jxpress_login',    // 存储用户名信息的 key，默认是 vdoing_login。系统通过该 key 验证是否登录、是否过期。（请不要与任意文章中 frontmatter 的 title 冲突）
